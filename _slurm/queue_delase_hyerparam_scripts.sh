...
HYDRA_FULL_ERROR=1 python /om2/user/eisenaj/code/UniversalUnconsciousness/UniversalUnconsciousness/DeLASE_analysis/delase_hyperparam_queueing_script.py
